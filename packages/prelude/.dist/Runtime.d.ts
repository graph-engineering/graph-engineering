...
export * from "io-ts";
export declare type ReadonlyTypeOf<A extends Runtime.Any> = Readonly<
  Runtime.TypeOf<A>
>;
export declare const maybe: <A extends Runtime.Any>(
  type: A
...
export declare const messageFromError: (
