...
export declare const toEnglishShort: (time: number) => Either.Either<Error, string>;
export declare const toEnglishLong: (time: number) => Either.Either<Error, string>;
export declare const fromEnglish: (english: string) => Either.Either<Error, number>;
