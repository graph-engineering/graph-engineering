...
export declare const stringifyShort: (value: unknown) => Either.Either<Error, string>;
export declare const stringifyPretty: (value: unknown) => Either.Either<Error, string>;
